...
def build_block_parser(md_instance, **kwargs):
    ...
    parser.blockprocessors['indent'] = ParagraphProcessor(parser)
    # parser.blockprocessors['code'] = CodeBlockProcessor(parser)
    parser.blockprocessors['code'] = ParagraphProcessor(parser)
